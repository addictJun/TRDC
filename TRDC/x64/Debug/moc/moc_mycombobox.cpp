...
QT_MOC_LITERAL(3, 19, 11), // "TRData::Ptr"
QT_MOC_LITERAL(4, 31, 4) // "data"

    },
    "myComboBox\0signal\0\0TRData::Ptr\0data"
};
...
void myComboBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal((*reinterpret_cast< TRData::Ptr(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (myComboBox::*_t)(TRData::Ptr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myComboBox::signal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myComboBox::signal(TRData::Ptr _t1)
{
